            ...
            <div className="space-y-6 animate-fade-in">
              <div className="inline-block">
                <span className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                  🔥 {banner?.badge || "Bộ Sưu Tập Mới 2025"}
                </span>
              </div>
              <h1 className="text-6xl font-bold leading-tight">
                <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                  {banner?.title || "Phong Cách"}
                </span>
                <br />
                <span className="text-gray-800">{banner?.subtitle || "Đẳng Cấp"}</span>
              </h1>
              <p className="text-xl text-gray-600">
                {banner?.description || "Khám phá những xu hướng thời trang mới nhất, nơi phong cách gặp gỡ sự thoải mái"}
              </p>
