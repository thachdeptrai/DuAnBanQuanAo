    ...
    },
    {
      ...
      indexes: [
        // === UNIQUE KEY (product_id, is_primary) ===
        {
          ...
          where: {
            is_primary: true, // Sequelize hỗ trợ unique có điều kiện
          },
          name: "unq_primary_per_product",
        },

        // === INDEXES như SQL ===
        {
          fields: ["product_id", "sort_order"],
          name: "idx_product_order",
        },
        {
          fields: ["variant_id", "sort_order"],
          name: "idx_variant_media",
        },
        {
          fields: ["product_id", "media_type"],
          name: "idx_media_type",
        },
      ],
    }
